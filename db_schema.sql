...
CREATE TABLE IF NOT EXISTS dog (
    ...
    dog_age TEXT NOT NULL CHECK(dog_age IN('Puppy', 'Adult', 'Senior')),
    dog_size TEXT NOT NULL CHECK(dog_size IN('S', 'M', 'L', 'XL')),
    dog_photo TEXT DEFAULT "No photo",
